...
// Selected high-quality atmospheric shots for the gallery
const VITTORIALE_IDS = [
    "1EH_aERQ-tSGvQHLYz0B2jqhsgEM7jRQa", // Biblioteca
    "1x9C7AUakBCgTm61v9YMD-Z-rX8Tpj8UE", // Camera
    "1Pt3POMd497c5CwmxrL4liOe14govR2F6", // Cucina
    "13QLMz-Z9U5eI71blc4razaqYr3HRtNGE", // Fontana
    "1VNVyxn65h2Pvpp4cGdc9JJ_PPeXm8Jvy", // Telefono
    "1ZUaV9rQhMq2vmINhQ1KBHcquFy0VicF2", // Camera angle 2
    "1kSyoEZvzGbTignvOVh8qJ65MjLva7TvE", // Tomba Duse (Atmosphere)
    "1vs5um3mO8TNPFHQ1MzEkfMoMl8ZD0T2e", // Pagine Inedite
];
...
export const FRAGMENTS: Fragment[] = [
  // --- 1. LA GENESI (FULL BIO) ---
  {
    ...
    rotation: -5,
    meta: "Vita del Vate",
    summary: "D'Annunzio trasforma la sua intera vita in un'opera d'arte inimitabile. Ecco le fasi salienti:\n• Il Ragazzo Prodigio: Esordisce a 16 anni e finge la propria morte per marketing.\n• Il Dandy Romano: A Roma conquista i salotti, vive nel lusso e scrive 'Il Piacere'.\n• L'Eroe di Guerra: A 52 anni compie imprese folli come il Volo su Vienna.\n• Il Recluso: Finisce i suoi giorni nel lusso funebre del Vittoriale.",
    content: [
    ...
    // Giovane D'Annunzio
    image: `${DRIVE_BASE}1SkjWTGZNnyoqpPdo34ekEvMXqMWQgoqn`,
    analysis: {
  ...
  // --- 2. IL PIACERE (FULL TEXT FROM USER) ---
  {
    ...
    summary: "Romanzo manifesto dell'Estetismo. Andrea Sperelli cerca di fare la propria vita 'come un'opera d'arte', ma fallisce.\n• Andrea Sperelli: L'alter ego dell'autore, colto e raffinato.\n• Elena Muti: La passione carnale e distruttiva.\n• Maria Ferres: La purezza spirituale.\n• Il Finale: Sperelli perde entrambe e resta solo con la sua arte sterile.",
    content: [
    ...
    image: `${DRIVE_BASE}1dFtsUAtl_hjBskhmSNAIyCDZ5WwCtSGW`,
  },
  ...
  // --- 3. LA DIVINA (FULL TEXT FROM USER) ---
  {
    ...
    rotation: -4,
    meta: "Eleonora Duse",
    summary: "Eleonora Duse e D'Annunzio: amore e arte alla villa della Capponcina.\n• Il Sodalizio: Lei finanzia i suoi sogni, lui scrive opere immortali per lei.\n• La Vita in Villa: Vivono nel lusso rinascimentale tra Firenze e Fiesole.\n• Il Tradimento: Nel romanzo 'Il Fuoco', D'Annunzio svela il declino fisico dell'attrice, sacrificando l'amore per l'arte.",
    content: [
    ...
    // Duse Cleopatra
    image: `${DRIVE_BASE}1wBSMBmIKcBaoGaMqADd_q42PdnHUYA8D`,
  },
  ...
  // --- NEW: ALCYONE (COMPLETE TEXT SPLIT) ---
  {
    ...
    summary: "Il diario lirico di un'estate in Versilia e il capolavoro del Vate.\n• Struttura: Diviso in 5 sezioni che seguono l'estate da giugno a settembre.\n• Panismo: L'uomo si fonde con la natura, diventando albero, luce e pioggia.\n• Stile: Musicalità pura, dove la parola evoca sensazioni fisiche.",
    content: [
        // Slide 1: Intro
    ...
    // Motoscafo Alcyone
    image: `${DRIVE_BASE}1bBXKNMAaqSUkF1HQjMOR9R4MPOOYySjZ`
  },
  ...
  // --- NEW: LA SERA FIESOLANA (UPDATED WITH POEM & PARAPHRASE) ---
  {
    ...
    summary: "L'incanto della Sera che scende sulle colline.\n• Strofa 1 (La Luna): Il sorgere della luna porta freschezza e pace alla campagna.\n• Strofa 2 (La Pioggia): Il ricordo di un temporale primaverile che ha bagnato i pini.\n• Strofa 3 (Il Mistero): Le colline sembrano labbra chiuse che celano un segreto.\n• Il Ritornello: Ogni strofa si chiude con una 'Laude' francescana ('Laudata sii').",
    content: [
    ...
    // Giardino Vittoriale (Atmospheric nature for Sera Fiesolana)
    image: `${DRIVE_BASE}1j2UJ9PIGkrodfRk4r9Zn_qhHINGzvvAw`
  },
  ...
  { 
    ...
    rotation: 5, 
    meta: "Estate 1902",
    summary: "Il vertice del Panismo. Il poeta ed Ermione diventano tutt'uno con il bosco.\n• L'Orchestra: La pioggia crea suoni diversi su ogni albero (pini, mirti, ginepri).\n• La Metamorfosi: I volti diventano 'silvani', il cuore 'pesca', i denti 'mandorle'.\n• La Favola Bella: L'amore è una dolce illusione che inganna i sensi.",
    content: [
    ...
    // Fontana Vittoriale (Water theme)
    image: `${DRIVE_BASE}13QLMz-Z9U5eI71blc4razaqYr3HRtNGE`,
    analysis: {
        title: "Modernità",
        paragraphs: [
  ...
  // --- 6. IL NOTTURNO ---
  {
    ...
    rotation: -2,
    meta: "Dolore",
    summary: "Il 'Commentario della tenebra', scritto da un poeta reso cieco.\n• Il Trauma: Ferito a un occhio in guerra, resta immobile al buio a Venezia.\n• I Cartigli: Scrive su sottili strisce di carta, senza poter rileggere.\n• Lo Stile: Abbandona la retorica per frasi brevi, sincere e cariche di dolore.",
    content: [
    ...
    // Ufficio Vittoriale
    image: `${DRIVE_BASE}10xQWnOSyp6E3_DTql_KfaLVqytsYiKmn`,
    details: {
  ...
  // --- 7. L'IMPRESA ---
  {
    ...
    rotation: 5,
    meta: "Fiume & Carnaro",
    summary: "D'Annunzio occupa Fiume e fonda una 'Città di Vita' rivoluzionaria.\n• L'Azione: Occupa la città con i legionari contro il volere del governo.\n• Carta del Carnaro: Una costituzione futuristica che garantisce voto alle donne, divorzio e libertà sessuale.\n• La Fine: Bombardato dall'Italia nel 'Natale di Sangue' del 1920.",
    content: [
    ...
    // Volantino Impresa
    image: `${DRIVE_BASE}1D3bXPHAFzX9wd3rmFrZimgIQhRLxfL7V`,
    analysis: {
  ...
  // --- 8. IL VITTORIALE ---
  {
    ...
    rotation: 0,
    meta: "Mausoleo",
    summary: "Il 'Libro di Pietre Viventi'. L'ultima grande opera del Vate.\n• La Prioria: Una casa oscura piena di simboli e reliquie, creata per stupire.\n• Il Parco: Ospita una nave da guerra vera (Nave Puglia) e il Mausoleo.\n• Il Mito: Dona il complesso agli italiani per garantirsi l'immortalità.",
    content: "La prigione dorata. Una casa che è un labirinto di simboli.",
    // Nave Puglia (Main Image)
    image: `${DRIVE_BASE}1HlfbXONjYlGo3vuk3_dkxWs6XgM_QA8B`, 
  ...
  { 
    ...
    scale: 1.1, 
    rotation: 0, 
    summary: "Interroga lo Spirito del Vate.\n• Non è una chat: Risponde per enigmi, visioni e frammenti poetici.\n• Chiedi: Ispirazione, dettagli nascosti o un verso immortale.",
